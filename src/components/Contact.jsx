          ...
          <div className="bg-white p-8 rounded-xl shadow-xl">
            ...
            <form>
              <div className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-secondary text-white font-bold py-4 rounded-lg hover:bg-opacity-90 hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                >
                  Send Message
                </button>
              </div>
