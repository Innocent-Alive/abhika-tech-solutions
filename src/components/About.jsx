    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w- font-body mx-auto text-lg text-text leading-relaxed">
          ...
          <p>
            We specialize in crafting bespoke software solutions tailored to your unique needs, ranging from dynamic, high-performance web platforms to intuitive, engaging mobile applications. Our development process is characterized by complete transparency and an agile methodology, allowing us to adapt quickly to evolving requirements and deliver results efficiently. Our ultimate goal is not just to meet, but to consistently exceed your expectations. At Abhika Tech Solution, we see ourselves as more than just a service provider; we are your dedicated technology partner, wholly committed to architecting your digital success story.
          </p>
        </div>
      </div>
    </section>
